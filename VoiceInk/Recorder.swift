...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.tala", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "com.prakashjoshipax.tala.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "com.prakashjoshipax.tala.audioSetup", qos: .userInitiated)
