        ...
        Section("AI Provider Integration") {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                if aiService.selectedProvider == .ollama {
                    ...
                    Text("Environment variables available: TALA_SYSTEM_PROMPT, TALA_USER_PROMPT, TALA_FULL_PROMPT. Tala also writes TALA_FULL_PROMPT to stdin for every command.")
                        .font(.caption)
                        .foregroundColor(.secondary)
