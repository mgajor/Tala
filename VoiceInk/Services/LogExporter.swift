...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.tala", category: "LogExporter")
    private let subsystem = "com.prakashjoshipax.tala"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== Tala Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "Tala_Logs_\(timestamp).log"
